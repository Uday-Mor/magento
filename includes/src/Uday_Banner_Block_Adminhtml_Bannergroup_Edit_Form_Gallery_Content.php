<?php
class Uday_Banner_Block_Adminhtml_Bannergroup_Edit_Form_Gallery_Content extends Mage_Adminhtml_Block_Widget
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->getUploader()->getUploaderConfig()
            ...
            ->setTarget(Mage::getModel('adminhtml/url')->addSessionParam()->getUrl(
                'banner/adminhtml_bannergroup/upload/group_id/'.$groupId
            ));
