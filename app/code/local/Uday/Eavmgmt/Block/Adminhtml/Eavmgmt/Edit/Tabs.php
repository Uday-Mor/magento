...
class Uday_Eavmgmt_Block_Adminhtml_Eavmgmt_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->addTab('form_section_address', array(
            'label' => Mage::helper('eavmgmt')->__('Addresses'),
            'content' => $this->getLayout()->createBlock('eavmgmt/adminhtml_eavmgmt_edit_tab_addresses')->toHtml(),
        ));
