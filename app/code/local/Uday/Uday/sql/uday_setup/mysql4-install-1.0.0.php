...
$table = $installer->getConnection()
    ->newTable($installer->getTable('uday'))
    ...
    ->addIndex($installer->getIdxName('uday', array('entity_type_id')),
        array('entity_type_id'))
    ->addIndex($installer->getIdxName('uday', array('attribute_set_id')),
        array('attribute_set_id'))
    ->addIndex($installer->getIdxName('uday', array('sku')),
        array('sku'))
    ->addForeignKey(
        $installer->getFkName(
            'uday',
    ...
    ->addForeignKey($installer->getFkName('uday', 'entity_type_id', 'eav/entity_type', 'entity_type_id'),
