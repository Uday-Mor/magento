<?php
class Uday_Uday_Model_Resource_Attribute extends Mage_Eav_Model_Resource_Entity_Attribute
{
    ...
    protected function _clearUselessAttributeValues(Mage_Core_Model_Abstract $object)
    {
        ...
        if ($object->isScopeGlobal()
            ...
            && Uday_Uday_Model_Resource_Eav_Attribute::SCOPE_GLOBAL != $origData['is_global']
        ) {
    ...
    public function deleteEntity(Mage_Core_Model_Abstract $object)
    {
        ...
        if ($result) {
            $attribute = Mage::getSingleton('eav/config')
                ->getAttribute(Uday_Uday_Model_Uday::ENTITY, $result['attribute_id']);
    ...
    public function isUsedBySuperProducts(Mage_Core_Model_Abstract $object, $attributeSet = null)
    {
        ...
        $productTable = $this->getTable('uday');
