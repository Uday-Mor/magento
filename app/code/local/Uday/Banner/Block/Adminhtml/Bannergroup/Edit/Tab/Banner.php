<?php
class Uday_Banner_Block_Adminhtml_Bannergroup_Edit_Tab_Banner extends Mage_Adminhtml_Block_Catalog_Form
{
    ...
    {
        $result = array(
            'gallery'  => Mage::getConfig()->getBlockClassName('banner/adminhtml_bannergroup_edit_form_gallery'),
